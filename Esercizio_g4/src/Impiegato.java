...
public class Impiegato extends Worker implements IStampa {

	public Impiegato(String matricola, double stipendio, double importoOrarioStraordinario, Livello livello,
