...
import com.epicode.prenotazione.security.repository.PrenotationRepository;
...
public class PrenotationService {
	...
	public List<Prenotation> book(){
		List <Prenotation> allBookings = (List<Prenotation>) pre.findAll();
		return allBookings;
	}
	
	public Prenotation findSingleBooking(Long id) {
		Prenotation p = pre.findById(id).get();
		return p;
	}
